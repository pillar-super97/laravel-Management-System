...
<table class="my-3 sub-heading col-12 p-1">
    <tr>
        ...
        <td class="text-center align-top sub-heading">Location Consolidation Report <br> Final</td>
        <td class="text-right">
...
<table class="table table-striped" id="myTable" style="font-size:10px;">
    ...
    <tbody>
        ...
        <tr>
            <td class="left strong"><?=  $cr['location_id']; ?></td>
            <td class="left strong"><?=  $cr['category_name'].'<br />'.$cr['store_type'] ?></td>
            <td class="left">
                <?php
