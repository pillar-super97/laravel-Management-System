<meta charset="utf-8">
<title>
    {{ trans('global.global_title') }} || @yield('pageTitle')
</title>
...
<!--<footer class="main-footer" style=" position: fixed ; bottom:0px; z-index: 999; width: 100%;">
     <strong>Copyright &copy; <?php //echo date('Y');?> Powered by <a href="http://msi-inv.com" target="blank">MSI-INV Scheduler</a> </strong>
    <span style="float: right;margin-right:220px;">Last Login - </span>
</footer>-->