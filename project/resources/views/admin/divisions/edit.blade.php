@extends('layouts.app')
@section('pageTitle', 'Edit Division')
@section('content')
    <h3 class="page-title">Divisions</h3>
    
    {!! Form::model($division, ['method' => 'PUT', 'route' => ['admin.divisions.update', $division->id], 'files' => true,'autocomplete'=>'off']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-xs-3 form-group{{ $errors->has('client_id') ? ' has-error' : '' }}">
                    ...
                    <select id="client_id" class="form-control" name="client_id" >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$division->client_id){echo 'selected="selected"';}?>><?php echo $client;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group{{ $errors->has('state_id') ? ' has-error' : '' }}">
                    ...
                    <select id="primary_state" dropdown="primary" class="form-control state_dropdown select2" name="state_id"  required="">
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$division->state_id){echo 'selected="selected"';}?>><?php echo $state;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('city_id') ? ' has-error' : '' }}">
                    ...
                    <select id="primary_city" dropdown="primary" class="form-control city_dropdown select2" name="city_id"  required="">
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$division->city_id){echo 'selected="selected"';}?>><?php echo $city;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <input id="phone" type="text" name="phone" value="<?=$division->phone;?>" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask required="required">
                    <p class="help-block"></p>
                    @if($errors->has('phone'))
                        <p class="error-block">
                            {{ $errors->first('phone') }}
                ...
                <div class="col-xs-3 form-group{{ $errors->has('frequency') ? ' has-error' : '' }}">
                    ...
                    <select id="frequency" class="form-control" name="frequency"  >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$division->frequency){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('inv_type') ? ' has-error' : '' }}">
                    ...
                    <select id="inv_type" class="form-control" name="inv_type"  >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$division->inv_type){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('rate_per') ? ' has-error' : '' }}">
                    ...
                    <?php $schedule_availability_days = array();
                            if(count($division->schedule_availability_days)){foreach($division->schedule_availability_days as $day)$schedule_availability_days[] = $day->days;}
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <input id="scheduling_contact_phone" type="text" value="<?php echo $division->scheduling_contact_phone;?>" name="scheduling_contact_phone" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('scheduling_contact_state_id') ? ' has-error' : '' }}">
                    ...
                    <select id="scheduling_state" dropdown="scheduling" class="form-control state_dropdown select2" name="scheduling_contact_state_id">
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$division->scheduling_contact_state_id){echo 'selected="selected"';}?>><?php echo $state;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('scheduling_contact_city_id') ? ' has-error' : '' }}">
                    ...
                    <select id="scheduling_city" dropdown="scheduling" class="form-control city_dropdown select2" name="scheduling_contact_city_id">
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$division->scheduling_contact_city_id){echo 'selected="selected"';}?>><?php echo $city;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <input id="sec_scheduling_contact_phone" value="<?php echo $division->sec_scheduling_contact_phone;?>" type="text" name="sec_scheduling_contact_phone" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('sec_scheduling_contact_state_id') ? ' has-error' : '' }}">
                    ...
                    <select id="sec_scheduling_state" dropdown="sec_scheduling" class="form-control state_dropdown select2" name="sec_scheduling_contact_state_id"  >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$division->sec_scheduling_contact_state_id){echo 'selected="selected"';}?>><?php echo $state;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('sec_scheduling_contact_city_id') ? ' has-error' : '' }}">
                    ...
                    <select id="sec_scheduling_city" dropdown="sec_scheduling" class="form-control city_dropdown select2" name="sec_scheduling_contact_city_id"  >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$division->sec_scheduling_contact_city_id){echo 'selected="selected"';}?>><?php echo $city;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <input id="billing_contact_phone" type="text" value="<?php echo $division->billing_contact_phone;?>" name="billing_contact_phone" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('billing_contact_state_id') ? ' has-error' : '' }}">
                    ...
                    <select id="billing_state" dropdown="billing" class="form-control state_dropdown select2" name="billing_contact_state_id"  >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$division->billing_contact_state_id){echo 'selected="selected"';}?>><?php echo $state;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('billing_contact_city_id') ? ' has-error' : '' }}">
                    ...
                    <select id="billing_city" dropdown="billing" class="form-control city_dropdown select2" name="billing_contact_city_id"  >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$division->billing_contact_city_id){echo 'selected="selected"';}?>><?php echo $city;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                <div class="col-xs-3 form-group{{ $errors->has('rate_type') ? ' has-error' : '' }}">
                    ...
                    <select id="rate_type" class="form-control" name="rate_type" >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$division->rate_type){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('rate_per') ? ' has-error' : '' }}">
                    ...
                    <select id="rate_per" class="form-control" name="rate_per" >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$division->rate_per){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="col-xs-3 form-group">
                ...
                <div class="qccallrow <?php echo ($division->qccall=="No")?'hide':''?>">
                <div class="col-xs-3 form-group">
                ...
                <div class="col-xs-3 form-group <?php echo ($division->store_or_other=="store")?'hide':''?>">
            ...
            <div class="col-xs-3 form-group">
                ...
                <div class=" piccallrow <?php echo ($division->precall=="No")?'hide':''?>">
                <div class="col-xs-3 form-group">
                    <label class="control-label">Store or Other</label><br>
                    <label class="control-label">                   
                ...
                <div class="col-xs-3 form-group <?php echo ($division->precall=="No")?'hide':''?>">
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group{{ $errors->has('billing') ? ' has-error' : '' }}">
                     ...
                     <select id="billing" class="form-control" name="billing" >
                         ...
                         <option value="<?php echo $feq;?>" <?php if($feq==$division->billing){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                         <?php }?>
                     </select>
