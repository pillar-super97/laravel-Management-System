        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-xs-3 form-group{{ $errors->has('manager_id') ? ' has-error' : '' }}">
                 ...
                 <div class="col-xs-3 form-group{{ $errors->has('association_id') ? ' has-error' : '' }}">
                    <label for="client_id" class="control-label">Association</label>
                    <select id="association_id" class="form-control" name="association_id" >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->association_id){echo 'selected="selected"';}?>><?php echo $association;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                <div class="col-xs-3 form-group{{ $errors->has('client_id') ? ' has-error' : '' }}">
                    ...
                    <select id="client_id" class="form-control" name="client_id" >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->client_id){echo 'selected="selected"';}?>><?php echo $client;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('division_id') ? ' has-error' : '' }}">
                    ...
                    <select id="division_id" class="form-control" name="division_id" >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->division_id){echo 'selected="selected"';}?>><?php echo $division;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('district_id') ? ' has-error' : '' }}">
                    ...
                    <select id="district_id" class="form-control" name="district_id" >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->district_id){echo 'selected="selected"';}?>><?php echo $district;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('state_id') ? ' has-error' : '' }}">
                    ...
                    <select id="primary_state" dropdown="primary" class="form-control state_dropdown select2" name="state_id"  required="">
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->state_id){echo 'selected="selected"';}?>><?php echo $state;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('city_id') ? ' has-error' : '' }}">
                    ...
                    <select id="primary_city" dropdown="primary" class="form-control city_dropdown select2" name="city_id"  required="">
                        <?php foreach ($cities as $key=>$city){echo $key;?>
                        <option value="<?php echo $key;?>" <?php if($key==$store->city_id){echo 'selected="selected"';}?>><?php echo $city;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <input id="phone" type="text" name="phone" value="<?=$store->phone;?>" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask required="required">
                    <p class="help-block"></p>
                    @if($errors->has('phone'))
                        <p class="error-block">
                            {{ $errors->first('phone') }}
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <input id="scheduling_contact_phone" type="text" value="<?php echo $store->scheduling_contact_phone;?>" name="scheduling_contact_phone" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('scheduling_contact_state_id') ? ' has-error' : '' }}">
                    ...
                    <select id="scheduling_state" dropdown="scheduling" class="form-control state_dropdown select2" name="scheduling_contact_state_id">
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->scheduling_contact_state_id){echo 'selected="selected"';}?>><?php echo $state;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('scheduling_contact_city_id') ? ' has-error' : '' }}">
                    ...
                    <select id="scheduling_city" dropdown="scheduling" class="form-control city_dropdown select2" name="scheduling_contact_city_id">
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->scheduling_contact_city_id){echo 'selected="selected"';}?>><?php echo $city;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <input id="sec_scheduling_contact_phone" value="<?php echo $store->sec_scheduling_contact_phone;?>" type="text" name="sec_scheduling_contact_phone" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('sec_scheduling_contact_state_id') ? ' has-error' : '' }}">
                    ...
                    <select id="sec_scheduling_state" dropdown="sec_scheduling" class="form-control state_dropdown select2" name="sec_scheduling_contact_state_id"  >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->sec_scheduling_contact_state_id){echo 'selected="selected"';}?>><?php echo $state;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('sec_scheduling_contact_city_id') ? ' has-error' : '' }}">
                    ...
                    <select id="sec_scheduling_city" dropdown="sec_scheduling" class="form-control city_dropdown select2" name="sec_scheduling_contact_city_id"  >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->sec_scheduling_contact_city_id){echo 'selected="selected"';}?>><?php echo $city;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <input id="billing_contact_phone" type="text" value="<?php echo $store->billing_contact_phone;?>" name="billing_contact_phone" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('billing_contact_state_id') ? ' has-error' : '' }}">
                    ...
                    <select id="billing_state" dropdown="billing" class="form-control state_dropdown select2" name="billing_contact_state_id"  >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->billing_contact_state_id){echo 'selected="selected"';}?>><?php echo $state;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('billing_contact_city_id') ? ' has-error' : '' }}">
                    ...
                    <select id="billing_city" dropdown="billing" class="form-control city_dropdown select2" name="billing_contact_city_id"  >
                        ...
                        <option value="<?php echo $key;?>" <?php if($key==$store->billing_contact_city_id){echo 'selected="selected"';}?>><?php echo $city;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group{{ $errors->has('billing') ? ' has-error' : '' }}">
                    ...
                    <select id="billing" class="form-control required" required="" name="billing"  >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$store->billing){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('store_type') ? ' has-error' : '' }}">
                    ...
                    <select id="store_type" class="form-control required" required="" name="store_type"  >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$store->store_type){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('frequency') ? ' has-error' : '' }}">
                    ...
                    <select id="frequency" class="form-control" name="frequency"  >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$store->frequency){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                <div class="col-xs-3 form-group{{ $errors->has('inv_type') ? ' has-error' : '' }}">
                    ...
                    <select id="inv_type" class="form-control" name="inv_type"  >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$store->inv_type){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('rate_per') ? ' has-error' : '' }}">
                    ...
                    <select id="month_to_schedule" class="form-control select2" multiple="" name="month_to_schedule[]" >
                        ...
                        <option value="<?php echo $feq;?>" <?php if(in_array($feq,$schedule_months)){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('rate_type') ? ' has-error' : '' }}">
                    ...
                    <select id="rate_type" class="form-control" name="rate_type" >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$store->rate_type){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    ...
                    {!! Form::text('rate_effective_date', $rate_effective_date, ['class' => 'form-control datepicker','required' => 'required']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group{{ $errors->has('rate_per') ? ' has-error' : '' }}">
                    ...
                    <select id="rate_per" class="form-control" name="rate_per" >
                        ...
                        <option value="<?php echo $feq;?>" <?php if($feq==$store->rate_per){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-xs-3 form-group">
                    ...
                    {!! Form::text('inventory_level', old('inventory_level'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-3 form-group{{ $errors->has('apr') ? ' has-error' : '' }}">
                    ...
                    <select id="apr" class="form-control select2" name="apr" >
                        <option value="">Select Area</option>
                        <?php foreach ($areas as $feq){?>
                        <option value="<?php echo $feq->id;?>" <?php if($feq->id==$store->apr){echo 'selected="selected"';}?>><?php echo $feq->title;?></option>
                        <?php }?>
                    </select>
                    @if ($errors->has('apr'))
                        <p class="error-block">
...
<!--                <div class="col-xs-3 form-group{{ $errors->has('jsa') ? ' has-error' : '' }}">
                    ...
                    <select id="jsa" class="form-control select2" multiple="" name="jsa[]" >
                        <option value="">Select JSA</option>
                        <?php //foreach ($jsas as $key=>$feq){?>
                        <option value="<?php //echo $feq->id;?>" <?php //if(in_array($feq->id,$selected_jsa_areas)){echo 'selected="selected"';}?>><?php //echo $feq->title;?></option>
                        <?php //}?>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group qccallrow <?php echo ($store->qccall=="No")?'hide':''?>"">
                ...
                <div class="col-xs-3 form-group qccallrow <?php echo ($store->store_or_other=="store")?'hide':''?>">
            ...
            <div class="col-xs-3 form-group">
                ...
                <div class="piccallrow <?php echo ($store->precall=="No")?'hide':''?>">
                <div class="col-xs-3 form-group">
                    <label class="control-label">Store or Other</label><br>
                    <label class="control-label">                   
                ...
                <div class="col-xs-3 form-group piccallrow <?php echo ($store->picstore_or_other=="store")?'hide':''?>">
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <label class="control-label">                   
                        {!! Form::radio('fuel_center','Yes',['class' => 'form-control','required']) !!} Yes
                    </label>
                    <label class="control-label">                   
                        {!! Form::radio('fuel_center','No',['class' => 'form-control','required']) !!} No
                    </label>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group">
                    ...
                    <label class="control-label">                   
                        {!! Form::radio('rx','Yes',['class' => 'form-control','required']) !!} Yes
                    </label>
                    <label class="control-label">                   
                        {!! Form::radio('rx','No',['class' => 'form-control','required']) !!} No
                    </label>
                    <p class="help-block"></p>
                    @if($errors->has('rx'))
                        <p class="error-block">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::textarea('terms', old('terms'), ['class' => 'form-control ','required', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('terms'))
                        <p class="error-block">
                            {{ $errors->first('terms') }}
    ...
    $(document).ready(function(){
       ...
       $('.piccall').click(function(){
        ...
        $('.piccallstoreother').click(function(){
            var store_or_other = $('input[name="picstore_or_other"]:checked').val();
            if(store_or_other=="other")
            {
               $(".piccallother").show().removeClass('hide');
        ...
        $(document).on('change','#client_id',function(){
            ...
            if(clientID)
            {
               ...
               success:function(res){
                    ...
                    //alert(res.client.scheduling_state.length);
            ...
            if(district_id)
            {
               ...
               success:function(res){
                    ...
                    if(res.district.state_id)
                    {
                        ...
                        $('#primary_state').val(res.district.state_id);
                    }
