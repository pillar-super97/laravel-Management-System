...
{!! Form::model($store, ['method' => 'PUT', 'route' => ['admin.stores.update', $store->id], 'files' =>
true,'autocomplete'=>'off']) !!}

<div class="panel panel-default">
    <div class="panel-heading">View Store</div>
    <?php $arrays = arrays();?>
    <div class="panel-body">
        <div class="row">
            <div class="col-xs-3 form-group">
                {!! Form::label('number', 'Number', ['class' => 'control-label required']) !!}
                {!! Form::text('number', old('number'), ['class' => 'form-control','disabled', 'placeholder' => '',
                'required' => '']) !!}
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('name', 'Name', ['class' => 'control-label required']) !!}
                {!! Form::text('name', old('name'), ['class' => 'form-control','disabled', 'placeholder' => '',
                'required' => '']) !!}
            </div>
            ...
            <div class="col-xs-3 form-group">
                ...
                {!! Form::text('address', old('address'), ['class' => 'form-control','disabled', 'placeholder' =>
                '','required' => '']) !!}
            </div>
            ...
            <div class="col-xs-3 form-group{{ $errors->has('state_id') ? ' has-error' : '' }}">
                ...
                <select id="primary_state" dropdown="primary" disabled="" class="form-control state_dropdown"
            ...
            <div class="col-xs-3 form-group{{ $errors->has('city_id') ? ' has-error' : '' }}">
                ...
                <select id="primary_city" dropdown="primary" disabled="" class="form-control city_dropdown"
            ...
            <div class="col-xs-3 form-group">
                ...
                <input id="phone" type="text" name="phone" disabled="" value="<?=$store->phone;?>" class="form-control"
                    data-inputmask='"mask": "(999) 999-9999"' data-mask required="required">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-3 form-group">
                ...
                {!! Form::text('scheduling_contact_email', old('scheduling_contact_email'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('scheduling_contact_name', 'Name', ['class' => 'control-label required']) !!}
                {!! Form::text('scheduling_contact_name', old('scheduling_contact_name'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('scheduling_contact_address', 'Address', ['class' => 'control-label required']) !!}
                {!! Form::text('scheduling_contact_address', old('scheduling_contact_address'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('scheduling_contact_phone', 'Phone', ['class' => 'control-label required']) !!}
                <input id="scheduling_contact_phone" type="text" disabled=""
                    value="<?php echo $store->scheduling_contact_phone;?>" name="scheduling_contact_phone"
            ...
            <div class="col-xs-3 form-group{{ $errors->has('scheduling_contact_state_id') ? ' has-error' : '' }}">
                ...
                <select id="scheduling_state" dropdown="scheduling" disabled="" class="form-control state_dropdown"
                    name="scheduling_contact_state_id" required="">
            ...
            <div class="col-xs-3 form-group{{ $errors->has('scheduling_contact_city_id') ? ' has-error' : '' }}">
                ...
                <select id="scheduling_city" dropdown="scheduling" disabled="" class="form-control city_dropdown"
                    name="scheduling_contact_city_id" required="">
                    <option><?php echo @$store->scheduling_city->name;?></option>
                </select>
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('scheduling_contact_zip', 'Zip', ['class' => 'control-label']) !!}
                {!! Form::text('scheduling_contact_zip', old('scheduling_contact_zip'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-3 form-group">
                ...
                {!! Form::text('sec_scheduling_contact_email', old('sec_scheduling_contact_email'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('sec_scheduling_contact_name', 'Name', ['class' => 'control-label']) !!}
                {!! Form::text('sec_scheduling_contact_name', old('sec_scheduling_contact_name'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('sec_scheduling_contact_address', 'Address', ['class' => 'control-label']) !!}
                {!! Form::text('sec_scheduling_contact_address', old('sec_scheduling_contact_address'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('sec_scheduling_contact_phone', 'Phone', ['class' => 'control-label']) !!}
                <input id="sec_scheduling_contact_phone" disabled=""
                    value="<?php echo $store->sec_scheduling_contact_phone;?>" type="text"
                    name="sec_scheduling_contact_phone" class="form-control" data-inputmask='"mask": "(999) 999-9999"'
                    data-mask>
            </div>
            ...
            <div class="col-xs-3 form-group{{ $errors->has('sec_scheduling_contact_state_id') ? ' has-error' : '' }}">
                ...
                <select id="sec_scheduling_state" dropdown="sec_scheduling" disabled=""
                    class="form-control state_dropdown" name="sec_scheduling_contact_state_id">
            ...
            <div class="col-xs-3 form-group{{ $errors->has('sec_scheduling_contact_city_id') ? ' has-error' : '' }}">
                ...
                <select id="sec_scheduling_city" dropdown="sec_scheduling" disabled=""
                    class="form-control city_dropdown" name="sec_scheduling_contact_city_id">
                    <option><?php echo @$store->sec_scheduling_city->name;?></option>
                </select>
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('sec_scheduling_contact_zip', 'Zip', ['class' => 'control-label']) !!}
                {!! Form::text('sec_scheduling_contact_zip', old('sec_scheduling_contact_zip'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-3 form-group">
                ...
                {!! Form::text('billing_contact_email', old('billing_contact_email'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('billing_contact_name', 'Name', ['class' => 'control-label']) !!}
                {!! Form::text('billing_contact_name', old('billing_contact_name'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}

            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('billing_contact_address', 'Address', ['class' => 'control-label']) !!}
                {!! Form::text('billing_contact_address', old('billing_contact_address'), ['class' =>
                'form-control','disabled', 'placeholder' => '']) !!}

            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('billing_contact_phone', 'Phone', ['class' => 'control-label']) !!}
                <input id="billing_contact_phone" type="text" disabled=""
                    value="<?php echo $store->billing_contact_phone;?>" name="billing_contact_phone"
                    class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
            ...
            <div class="col-xs-3 form-group{{ $errors->has('billing_contact_state_id') ? ' has-error' : '' }}">
                ...
                <select id="billing_state" dropdown="billing" disabled="" class="form-control state_dropdown"
                    name="billing_contact_state_id">
            ...
            <div class="col-xs-3 form-group{{ $errors->has('billing_contact_city_id') ? ' has-error' : '' }}">
                ...
                <select id="billing_city" dropdown="billing" disabled="" class="form-control city_dropdown"
                    name="billing_contact_city_id">
            ...
            <div class="col-xs-3 form-group">
                ...
                {!! Form::text('billing_contact_zip', old('billing_contact_zip'), ['class' => 'form-control','disabled',
                'placeholder' => '']) !!}
            </div>
        </div>
        <hr>
        <div class="row">
            <div class="col-xs-3 form-group">
                ...
                {!! Form::text('minbilling', old('minbilling'), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
               
            </div>
            <div class="col-xs-3 form-group{{ $errors->has('billing') ? ' has-error' : '' }}">
                <label for="billing" class="control-label required">Billing</label>
                <select id="billing" class="form-control required" required="" disabled>
                    <option value="0">Select Billing Type</option>
                    <?php foreach ($arrays['billing'] as $key=>$feq){?>
                    <option value="<?php echo $feq;?>" <?php if($feq==$store->billing){echo 'selected="selected"';}?>>
                        <?php echo $feq;?></option>
                    <?php }?>
                </select>
            ...
            <div class="col-xs-3 form-group{{ $errors->has('store_type') ? ' has-error' : '' }}">
                ...
                <select id="store_type" class="form-control required" disabled>
                    <option value="">Select Store Type</option>
                    <?php foreach ($arrays['store_types'] as $key=>$feq){?>
                    <option value="<?php echo $feq;?>"
                        <?php if($feq==$store->store_type){echo 'selected="selected"';}?>><?php echo $feq;?></option>
                    <?php }?>
                </select>
            ...
            <div class="col-xs-3 form-group{{ $errors->has('frequency') ? ' has-error' : '' }}">
                ...
                <select id="frequency" class="form-control" disabled>
                    ...
                    <option value="<?php echo $feq;?>" <?php if($feq==$store->frequency){echo 'selected="selected"';}?>>
                        <?php echo $feq;?></option>
                    <?php }?>
                </select>
        ...
        <div class="row">
            <div class="col-xs-3 form-group{{ $errors->has('inv_type') ? ' has-error' : '' }}">
                ...
                <select id="inv_type" class="form-control" disabled>
                    <option value="">Select Inventory Type</option>
                    <?php foreach ($arrays['inv_type'] as $key=>$feq){?>
                    <option value="<?php echo $feq;?>" <?php if($feq==$store->inv_type){echo 'selected="selected"';}?>>
                        <?php echo $feq;?></option>
                    <?php }?>
                </select>
            ...
            <div class="col-xs-3 form-group{{ $errors->has('rate_per') ? ' has-error' : '' }}">
                ...
                <select id="days_avai_to_schedule" class="form-control select2" multiple=""
                    name="days_avai_to_schedule[]" disabled>
                    <option value="">Select Days</option>
                    <?php foreach ($arrays['days'] as $key=>$feq){?>
                    <option value="<?php echo $feq;?>"
                        <?php if(in_array($feq,$schedule_availability_days)){echo 'selected="selected"';}?>>
                        <?php echo $feq;?></option>
                    <?php }?>
                </select>
            ...
            <div class="col-xs-3 form-group{{ $errors->has('rate_per') ? ' has-error' : '' }}">
                ...
                <?php $schedule_months = array();
                            ...
                            //print_r($schedule_availability_days);die;?>
                <select id="month_to_schedule" class="form-control select2" multiple="" name="month_to_schedule[]" disabled>
                    <option value="">Select Months</option>
                    <?php foreach ($arrays['months'] as $key=>$feq){?>
                    <option value="<?php echo $feq;?>"
                        <?php if(in_array($feq,$schedule_months)){echo 'selected="selected"';}?>><?php echo $feq;?>
                    </option>
                    <?php }?>
                </select>
            ...
            <div class="col-xs-3 form-group{{ $errors->has('rate_type') ? ' has-error' : '' }}">
                ...
                <select id="rate_type" class="form-control" name="rate_type" disabled>
                    <option value="">Select Rate Type</option>
                    <?php foreach ($arrays['rate_type'] as $key=>$feq){?>
                    <option value="<?php echo $feq;?>" <?php if($feq==$store->rate_type){echo 'selected="selected"';}?>>
                        <?php echo $feq;?></option>
                    <?php }?>
                </select>
        ...
        <div class="row">
            <div class="col-xs-3 form-group">
                ...
                {!! Form::text('rate', old('rate'), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
                
                
            </div>
            <div class="col-xs-3 form-group">
                <?php if($store->rate_effective_date){
                        $rate_effective_date = date('m/d/Y',strtotime($store->rate_effective_date));
                    }else{
                        $rate_effective_date='';
                    }?>
                ...
                !!}
                {!! Form::text('rate_effective_date', $rate_effective_date, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
                <p class="help-block"></p>
               
            </div>
            <div class="col-xs-3 form-group{{ $errors->has('rate_per') ? ' has-error' : '' }}">
                <label for="rate_per" class="control-label required">Rate Per</label>
                <select id="rate_per" class="form-control" disabled>
                    <option value="">Select Rate Per</option>
                    <?php foreach ($arrays['rate_per'] as $key=>$feq){?>
                    <option value="<?php echo $feq;?>" <?php if($feq==$store->rate_per){echo 'selected="selected"';}?>>
                        <?php echo $feq;?></option>
                    <?php }?>
                </select>
            ...
            <div class="col-xs-3 form-group">
                ...
                {!! Form::text('start_time', old('start_time'), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
               <p class="help-block"></p>
               
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('benchmark', 'Benchmark', ['class' => 'control-label required']) !!}
                {!! Form::text('benchmark', old('benchmark'), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
               
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('max_length', 'Max. Length', ['class' => 'control-label']) !!}
                {!! Form::text('max_length', old('max_length'), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
               
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('min_auditors', 'Min. Auditors', ['class' => 'control-label']) !!}
                {!! Form::text('min_auditors', old('min_auditors'), ['class' => 'form-control', 'disabled' => 'disabled'])
                !!}
                
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('spf', 'Supervisor Production Factor', ['class' => 'control-label required']) !!}
                {!! Form::text('spf', old('spf'), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
               
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('alr_disk', 'ALR Disk', ['class' => 'control-label required']) !!}
                {!! Form::text('alr_disk', old('alr_disk'), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
               
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('travel_charge', 'Travel Charge', ['class' => 'control-label']) !!}
                {!! Form::text('travel_charge', old('travel_charge'), ['class' => 'form-control', 'disabled' => 'disabled'])
                !!}
            ...
            <div class="col-xs-3 form-group">
                ...
                {!! Form::text('overnight_charge', old('overnight_charge'), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
              
            </div>
            <div class="col-xs-3 form-group">
                {!! Form::label('inventory_level', 'Inventory Level', ['class' => 'control-label required']) !!}
                {!! Form::text('inventory_level', old('inventory_level'), ['class' => 'form-control', 'disabled' => 'disabled']) !!}
        ...
        <div class="row">
            <div class="col-xs-3 form-group">
                ...
                <label for="apr" class="control-label">APR</label>
                    <select id="apr" class="form-control select2" disabled="" multiple="" disabled >
...
<!--                <div class="col-xs-3 form-group">
            ...
            <?php if($store->precall=="Yes"){?>
            <div>
                <div class="col-xs-3 form-group">
                    <label class="control-label">Store or Other</label><br>
                    <?php echo $store->picstore_or_other;?>
                </div>
                <?php if($store->picstore_or_other=="other"){?>
                <div class="col-xs-3 form-group">
                    <label class="control-label">Other Contact Name</label><br>
                    <?php echo $store->picother_contact_name;?>
                </div>
                <div class="col-xs-3 form-group">
                    <label class="control-label">Other Contact Number</label><br>
                    <?php echo $store->picother_contact_number;?>
                </div>
                <?php }?>
            </div>
            <?php }?>
