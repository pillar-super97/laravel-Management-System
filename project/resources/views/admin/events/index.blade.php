        ...
        <div class="panel-body table-responsive">
            ...
            <div class="row">
                 <div class="col-xs-3 form-group">
                    ...
                    <select id="area_id" class="form-control area_id select2" multiple="" name="area_id[]" >
                        <option value="">Select Area</option>
                        <?php foreach ($areas as $key=>$area){?>
                        <option value="<?php echo $key;?>" <?php if(($request->session()->get('area_id')) && in_array($key,$request->session()->get('area_id'))){echo 'selected="selected"';} ?>><?php echo $area;?></option>
                        <?php }?>
                    </select>
                </div>
                <div class="col-xs-3 form-group">
                ...
                <div class="col-xs-3 form-group" style="margin-top: 22px;">
                    <input type="checkbox" name="exclude_pic" value="1" id="exclude_pic" <?php if(($request->session()->get('exclude_pic'))){echo 'checked="checked"';} ?>><label for="exclude_pic">Exclude PIC</label>&nbsp;
                    <input type="checkbox" name="exclude_qc" value="1" id="exclude_qc" <?php if(($request->session()->get('exclude_qc'))){echo 'checked="checked"';} ?>><label for="exclude_qc">Exclude QC</label><br>
                    <input type="checkbox" name="exclude_scheduled" value="1" id="exclude_scheduled" <?php if(($request->session()->get('exclude_scheduled'))){echo 'checked="checked"';} ?>><label for="exclude_scheduled">Exclude Scheduled Events</label>
                </div>
            </div>
        </div>
    </div>
...
<!--<div class="modal fade" id="feedbackPopup" tabindex="-1" role="dialog" aria-labelledby="ratingReviewRate" aria-hidden="true">
    <div class="modal-dialog modal-dialog-custom" role="document">
        <div class="modal-content modal-content-custom">
            <div class="modal-body">
                <div class="row">		        
                    <div class="col-md-10"><h4 class="modal-title modal-title-custom" id="exampleModalLabel"><strong>Event Feedback</strong></h4></div>
                    <div class="col-md-2">
                ...
                <hr>
                <form method="POST" id="event_feedback" name="event_feedback" action="#">
                    <div class="row">
                        ...
                        <div class="col-xs-6 form-group">
                            {!! Form::label('positive_exp', 'Positive Experience', ['class' => 'control-label']) !!}
                            {!! Form::textarea('positive_exp', old('positive_exp'), ['class' => 'form-control ','rows'=>2,'required', 'placeholder' => '']) !!}
                        </div>
                        <div class="col-xs-6 form-group">
                            {!! Form::label('qc_comment', 'QC Comment', ['class' => 'control-label']) !!}
                            {!! Form::textarea('qc_comment', old('qc_comment'), ['class' => 'form-control ','rows'=>2,'required', 'placeholder' => '']) !!}
                        </div>
                        <div class="col-xs-6 form-group">
                            {!! Form::label('schedule_notes', 'Schedule Notes', ['class' => 'control-label']) !!}
                            {!! Form::textarea('schedule_notes', old('schedule_notes'), ['class' => 'form-control ','rows'=>2,'required', 'placeholder' => '']) !!}
                        </div>
                        <div class="col-xs-6 form-group">
                            {!! Form::label('field_comment', 'Field Comment', ['class' => 'control-label']) !!}
                            {!! Form::textarea('field_comment', old('field_comment'), ['class' => 'form-control ','rows'=>2,'required', 'placeholder' => '']) !!}
                        </div>
                        <div class="col-xs-3 form-group">
                            {!! Form::label('last_count_length', 'CT Length', ['class' => 'control-label']) !!}
                            {!! Form::text('last_count_length', old('last_count_length'), ['class' => 'form-control ','required', 'placeholder' => '']) !!}
                        </div>
                        <div class="col-xs-3 form-group">
                            {!! Form::label('last_count_production', 'Production Count', ['class' => 'control-label']) !!}
                            {!! Form::text('last_count_production', old('last_count_production'), ['class' => 'form-control ','required', 'placeholder' => '']) !!}
                        </div>
                        <div class="col-xs-3 form-group">
                            {!! Form::label('last_crew_count', 'Crew Count', ['class' => 'control-label']) !!}
                            {!! Form::text('last_crew_count', old('last_crew_count'), ['class' => 'form-control ','required', 'placeholder' => '']) !!}
                        </div>
                        <div class="col-xs-3 form-group">
                            {!! Form::label('last_inventory_value', 'Inventory Value', ['class' => 'control-label']) !!}
                            {!! Form::text('last_inventory_value', old('last_inventory_value'), ['class' => 'form-control ','required', 'placeholder' => '']) !!}
                        </div>
                    </div>
                    <div class="row">
                        <div class="blackout_dates_container">
                            <div class="col-xs-3" style="height:75px;">
                                ...
                                {!! Form::text('truck_dates[]', old('truck_dates'), ['class' => 'form-control datepicker', 'autocomplete'=>'off','placeholder' => '']) !!}
                            ...
                            <div class="col-xs-3 add_more" style="height:75px;"><i class="fa fa-plus" aria-hidden="true"></i> Add More </div>
                        </div>

                        <div class="col-md-12">
                            {!! Form::button('Submit', ['class' => 'btn btn-success save-event-feedback']) !!}
...
//                    $('#qc_comment').val(res.event.qc_comment);
//                    $('#precall_manager').val(res.event.precall_manager);
//                    $('#precall_comments').html(res.event.precall_comments);
//                    $("input[name='on_time'][value='"+res.event.on_time+"']").prop('checked', true);
//                    $("input[name='in_uniform'][value='"+res.event.in_uniform+"']").prop('checked', true);
//                    $("input[name='positive_exp'][value='"+res.event.positive_exp+"']").prop('checked', true);
//                }
...
//                            var html = '';
//                            $.each(res.pending_events,function(key,value){
//                                console.log(key);
