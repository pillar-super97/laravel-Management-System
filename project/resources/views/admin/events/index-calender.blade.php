...
<div class="panel panel-default">
    ...
    <div class="panel-body table-responsive">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 form-group {{$request->user()->client_id ? 'hidden' : ''}}">
                    ...
                    <select id="client_id" class="form-control client_id select2" multiple="" name="client_id[]" >
                        ...
                        <option value="<?php echo $key;?>" {{$key == @$request->user()->client_id ? 'selected' : ''}}><?php echo $client;?></option>
                        <?php }?>
                    </select>
                </div>
                <div class="col-xs-4 form-group">
...
<!--                <div class="col-xs-3 form-group">
            ...
            <div class="row">
                <div class="col-xs-4 form-group{{ $errors->has('supervisor') ? ' has-error' : '' }}">
                    <label for="supervisor" class="control-label">Supervisor</label>
                    <select id="supervisor" class="form-control select2" name="supervisor[]" multiple="" >
                ...
                <div class="col-xs-4 form-group" style="padding-top: 30px;">
    ...
    <div class="panel panel-default blackout_filter_panel" style="display: none;">
        ...
        <div class="panel-body ">
            <div class="row">
                <div class="col-xs-3 form-group">
                    <label for="blackout_client_id" class="control-label">Clients</label>
                    <select id="blackout_client_id" class="form-control blackout_client_id select2" multiple="" name="blackout_client_id[]" >
                        <option value="">Select Client</option>
                        <?php foreach ($clients as $key=>$client){?>
...
$(document).ready(function () {
    ...
    $("#enable_blackout_filter").on('change',function(){
        if($('#enable_blackout_filter').is(':checked'))
        {
            ...
            $('#blackout_client_id').val([]).trigger('change');
    ...
    $('#association_id,#client_id,#division_id,#district_id,#area_id,#store_id,.date_between,#supervisor,#blackout_client_id,#blackout_division_id,#blackout_district_id,#blackout_store_id').change(function(){
        init_events();
      });
