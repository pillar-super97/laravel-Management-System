...
<head>
  <title>MSI-INV | Forget Password</title>
  <meta charset="utf-8">
      ...
      <div class="row login-form-holder">
        <div class="col-lg-7 login-form">
              <a href="#"><img src="{{asset('uploads/login-logo.jpg')}}" alt="Msi-Inv" title="Msi-Inv" /></a>
               <h3 class="login-form-head FS-28">Forgot Password</h3>
               @if (session('status'))
              ...
              <form class="form-horizontal" role="form" method="POST" action="{{ url('password/email') }}">
                    ...
                    <div class="form-group row">
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-primary btn-block login-btn" Value="Send Password Reset Link">Send Password Reset Link</button>
