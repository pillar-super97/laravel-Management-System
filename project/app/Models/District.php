...
{
   use SoftDeletes;
    protected $fillable = ['number','manager','division_id','address','client_id','phone','country_id','state_id','city_id','zip','scheduling_contact_email','scheduling_contact_name',
        ...
        'spf','count_stockroom','precall','qccall','store_or_other','other_contact_name','other_contact_number','piccall','picstore_or_other','picother_contact_name','picother_contact_number','pieces_or_dollars','alr_disk','status','description'];
    ...
    {
        return $this->hasMany('App\Models\DistrictScheduleAvailabilityDays', 'district_id','id');
    }
